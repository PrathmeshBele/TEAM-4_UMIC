...
pub = rospy.Publisher('arrow_msg', String, queue_size=10)
bridge = CvBridge()
...
def show_image(img):
    cv2.imwrite('/home/prathmesh/Desktop/UMIC/TEAM-4_UMIC/src/mybot_description/scripts/lol.jpg',img)
    img=cv2.imread('/home/prathmesh/Desktop/UMIC/TEAM-4_UMIC/src/mybot_description/scripts/lol.jpg')
    plt.imshow(img)
...
def image_callback(img_msg):
   ...
   # rospy.loginfo(img_msg.header)
    ...
    try:
        ...
        #show_image(cv_image)
        cv2.imwrite('/home/prathmesh/Desktop/UMIC/TEAM-4_UMIC/src/mybot_description/scripts/lol2.jpg',cv_image)
        img=cv2.imread('/home/prathmesh/Desktop/UMIC/TEAM-4_UMIC/src/mybot_description/scripts/lol2.jpg')
